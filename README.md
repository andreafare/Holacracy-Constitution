...
The objective of this project is to evolve the Holacracy constitution  towards integrating relevant governance aspects that pertain to the adoption of AI in organizations. My first attempt is the creation of an [addendum](v0.1%20Agenti%20AI%20Holacracy-Constitution-addendum_Italian.md) that extends the [latest Holacracy Constitution](v5.0%20Holacracy-Constitution_Italian.md) . The addendum makes it possibile to assign AI agents to organizational roles in a way that fully integrates into the norms of the Holacracy Constitution.
